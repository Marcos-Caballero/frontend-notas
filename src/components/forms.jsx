...
function Form({oldNota}) {
    ...
    const saveNota = async () => { //Función para guardar notas
        ...
        let params = {}
        if(nota._id){
            URL = 'https://backend-notas-2g3dhhl6b-maicol-caballeros-projects.vercel.app' + nota._id;
            params = {
                method: 'PATCH',
            ...
            URL = 'https://backend-notas-2g3dhhl6b-maicol-caballeros-projects.vercel.app'
            params = {
                method: 'POST',
                body: JSON.stringify(nota),
                headers: {
