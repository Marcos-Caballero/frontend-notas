...
/* Esta es la función para eliminar las notas */
    const deleteNota = async(id) => { //Selecciono el id de la nota
        await fetch('https://backend-notas-2g3dhhl6b-maicol-caballeros-projects.vercel.app/api/notas/'+id, {
            method: 'DELETE',
            mode: 'cors'
        })
    }
    ...
    const getNota = async(id) =>{
        const nota = await fetch('https://backend-notas-2g3dhhl6b-maicol-caballeros-projects.vercel.app/api/notas/'+id)
