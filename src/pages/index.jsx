...
/* Aqui van las peticiones para modificar las notas */
    ...
    const getNotas = async() => {
        const response = await fetch('https://backend-notas-psi.vercel.app/api/notas/')
...
/* Esta es la función para eliminar las notas */
    const deleteNota = async(id) => { //Selecciono el id de la nota
        await fetch('https://backend-notas-psi.vercel.app/api/notas/'+id, {
            method: 'DELETE',
            mode: 'cors'
        })
    }
    ...
    const getNota = async(id) =>{
        const nota = await fetch('https://backend-notas-psi.vercel.app/api/notas/'+id)
